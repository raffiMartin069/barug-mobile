...
export const nationalityOptions = [
  ...
  { label: 'Indian', value: '8' },
  { label: 'British', value: '9' },
...
export const religionOptions = [
  { label: 'Roman Catholic', value: '1' },
  { label: 'Iglesia Ni Cristo', value: '2' },
  { label: 'Born Again', value: '3' },
  { label: 'Islam', value: '4' },
  { label: 'Protestant', value: '5' },
  { label: 'Buddhist', value: '6' },
  { label: 'Hindu', value: '7' },
  { label: 'Seventh-Day Adventist', value: '8' },
  { label: 'Agnostic', value: '9' },
