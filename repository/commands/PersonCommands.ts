...
export class PersonCommands {
    ...
    async FindNonResidentActivePerson(name: string) {
            try {
                ...
                if (error) {
                    console.warn('FindNonResidentActivePerson supabase error', error);
                    return [];
                }
                ...
                console.error('FindNonResidentActivePerson exception', e);
                return [];
            }
        }
